...
To generate forecasts for a chosen country and model, just pass the following arguments to the function `forecast` in [forecasting.py](./forecasting.py):
...
run the function `forecast_from_file` in [forecasting.py](./forecasting.py), with arguments:
- country: name of the chosen country;
